...
ros2 run tf2_ros static_transform_publisher -0.062 -0.005 0  0.5 -0.5 -0.5 0.5  tcp camera_link
...
python3 /home/sungboo/rb10_control/scripts/rosbag_to_hdf5.py --folder "" --out ""